(()=>{
  ...
  section.innerHTML=`
    <div class="panel-title"><div><h2 style="margin:0">Команды</h2><div class="muted">Логотип, город, арены, соцсети и официальный сайт.</div></div><button type="button" id="teamAdminReload" class="btn sec small">Обновить список</button></div>

(()=>{
  ...
  function injectStyle(){
    ...
    const s=document.createElement('style');s.id='news-richtext-editor-style';s.textContent=`
      .text-block .block-body{padding:0}.rte-shell{background:#091727}.rte-toolbar{display:flex;align-items:center;gap:5px;flex-wrap:wrap;padding:7px 10px;border-bottom:1px solid rgba(255,255,255,.075);background:#0b1a2b}
      .rte-kind{width:auto;min-width:165px;height:32px;padding:4px 30px 4px 10px;border:1px solid rgba(255,255,255,.11);border-radius:8px;background:#102238;color:#e4edf7;font-size:10px;font-weight:850;cursor:pointer}.rte-divider{width:1px;height:20px;background:rgba(255,255,255,.09);margin:0 2px}.rte-btn{min-width:32px;height:32px;padding:0 8px;border:1px solid rgba(255,255,255,.10);border-radius:8px;background:rgba(255,255,255,.025);color:#b8c8d8;font-size:12px;font-weight:850;cursor:pointer;transition:.15s ease}.rte-btn:hover,.rte-btn.active{color:#fff;border-color:rgba(127,198,255,.40);background:rgba(127,198,255,.10)}.rte-btn em{font-weight:650}.rte-btn u{text-underline-offset:2px}.rte-editor{min-height:96px;padding:14px 16px 16px;outline:none;color:#e7edf5;line-height:1.62;font-size:15px;caret-color:#7fc6ff;background:#081624}.rte-editor:focus{background:#09192a;box-shadow:inset 0 0 0 1px rgba(127,198,255,.10)}.rte-editor:empty:before{content:attr(data-placeholder);color:#536a80;pointer-events:none}.rte-editor p,.rte-editor div{margin:0 0 10px}.rte-editor p:last-child,.rte-editor div:last-child{margin-bottom:0}.rte-editor ul,.rte-editor ol{margin:8px 0 10px;padding-left:24px}.rte-editor li{margin:3px 0}.rte-editor blockquote{margin:10px 0;padding:9px 13px;border-left:3px solid #4d9ce8;border-radius:0 8px 8px 0;background:rgba(127,198,255,.055);color:#c8d8e8}.rte-editor a{color:#8dcbff;text-decoration:underline;text-underline-offset:2px}.rte-shell[data-style='heading'] .rte-editor{font-size:26px;line-height:1.2;font-weight:850;letter-spacing:-.025em;min-height:82px}.rte-shell[data-style='subtitle'] .rte-editor{font-size:19px;line-height:1.4;font-weight:700;color:#d4e1ef;min-height:82px}.block-text.rte-hidden{display:none!important}
      @media(max-width:680px){.rte-toolbar{gap:4px;padding:7px}.rte-kind{min-width:140px;flex:1}.rte-divider{display:none}.rte-btn{min-width:30px;height:30px;padding:0 7px}.rte-editor{min-height:88px;padding:12px 13px 14px}.rte-shell[data-style='heading'] .rte-editor{font-size:22px}.rte-shell[data-style='subtitle'] .rte-editor{font-size:17px}}

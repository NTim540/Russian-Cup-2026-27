...
#main{overflow-anchor:none}.mini-score.preparation{color:#bfe4ff!important;font-weight:950!important}.mini-score.live-period{color:#ff4652!important;font-weight:1000!important}.main-score-restored{font-size:clamp(58px,8vw,88px);font-weight:950;line-height:.9;letter-spacing:-.07em;margin:12px 0 4px}.main-score-restored.pending{color:#7f90a3}.match-state.preparation{color:#bfe4ff!important}
...
function loadGoalV2(){if(document.querySelector('script[data-goal-animation-v2]'))return;const g=document.createElement('script');g.src='/goal-animation-v2.js?v=20260920-2';g.async=true;g.dataset.goalAnimationV2='1';document.body.appendChild(g)}
